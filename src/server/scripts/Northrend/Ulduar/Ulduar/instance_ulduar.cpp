...
class instance_ulduar : public InstanceMapScript
{
    public:
        ...
        struct instance_ulduar_InstanceMapScript : public InstanceScript
        {
			...
			std::list<ObjectGuid> MimironDoorGUIDList;
            ...
            void Initialize() override
            {
                ...
                HodirRareCacheGUID               = ObjectGuid::Empty;
                ...
                SifGUID                          = ObjectGuid::Empty;
                ThorimLightningFieldGUID         = ObjectGuid::Empty;
                ...
                AncientGateGUID                  = ObjectGuid::Empty;
                stunned                          = true;
            ...
            bool SetBossState(uint32 type, EncounterState state) override
            {
                ...
                switch (type)
                {
                    ...
                    case BOSS_MIMIRON:
                        if (state == DONE)
                            instance->SummonCreature(NPC_MIMIRON_OBSERVATION_RING, ObservationRingKeepersPos[3]);
                        for (std::list<ObjectGuid>::iterator i = MimironDoorGUIDList.begin(); i != MimironDoorGUIDList.end(); i++)
